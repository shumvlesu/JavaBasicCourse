...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    persArray[1] = new Person("Петров Петр Петрович", "Сантехник", "", "891845524", 20000, 34);
    persArray[2] = new Person("Попкова Аида Вячеславовна", "Клинниг мастер", "", "8928555666", 0, 42);
    persArray[3] = new Person("Супрунов Валерий Николаевич", "Разнорабочий", "ааа@mail.com", "891855512", 25000, 52);
    persArray[4] = new Person("Соломахина Татьяна Михайловна", "Повар", "", "888812312", 60000, 30);
